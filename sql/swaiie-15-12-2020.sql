...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-12-2020 a las 22:54:33
...
--
ALTER TABLE `antivirus`
  MODIFY `id_antivirus` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `cpu`
--
ALTER TABLE `cpu`
  MODIFY `id_cpu` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `marca_modelo`
--
ALTER TABLE `marca_modelo`
  MODIFY `id_mm` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `os`
--
ALTER TABLE `os`
  MODIFY `id_os` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `software`
--
ALTER TABLE `software`
  MODIFY `id_software` int(50) NOT NULL AUTO_INCREMENT;
