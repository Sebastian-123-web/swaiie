...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-03-2021 a las 23:47:02
...
('MXL2150ZPZ', 'TBGRGAFSI002', 6, 500, 'HDD', 1, 2, 2, 2, 2, 1, 1, 'Operativo', '', 'rbanagasta'),
('UKSS564BV', 'TBGRGAFSI004', 8, 1000, 'SSD', 1, 2, 3, 4, 2, 1, 1, 'Inoperativo', '', 'ninguno');
...
--
ALTER TABLE `marca_modelo`
  MODIFY `id_mm` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
