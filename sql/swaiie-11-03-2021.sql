...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-03-2021 a las 23:38:51
...
INSERT INTO `equipo` (`id_equipo`, `nom_equipo`, `ram`, `disco`, `tipo_disco`, `id_mm`, `id_os`, `id_cpu`, `generacion`, `id_tipo`, `id_antivirus`, `id_software`, `mantenimiento`, `id_user`) VALUES
('GEJN3517', 'TBGRGAFSI007', 32, 2000, 'HDD', 2, 8, 3, 2, 2, 1, 1, 'Aqui va mantenimiento del equipo claro si es que se a hecho', 'rbanagasta'),
('RFD43D1FD3', 'TBGRGAFSI001', 32, 2000, 'HDD', 2, 8, 3, 8, 2, 1, 1, 'Equipo formateado', 'nin'),
('UKSS564BV', 'TBGRGAFSI004', 8, 1000, 'SSD', 1, 2, 3, 4, 2, 1, 1, '', 'nin');
...
--
ALTER TABLE `antivirus`
  MODIFY `id_antivirus` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
