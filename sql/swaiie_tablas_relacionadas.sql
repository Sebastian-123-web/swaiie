...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-08-2020 a las 09:48:16
...
ALTER TABLE `equipo`
  ...
  ADD CONSTRAINT `equipo_ibfk_4` FOREIGN KEY (`id_cpu`) REFERENCES `cpu` (`id_cpu`) ON UPDATE CASCADE,
  ADD CONSTRAINT `equipo_ibfk_5` FOREIGN KEY (`id_tipo`) REFERENCES `tipo` (`id_tipo`) ON UPDATE CASCADE,
  ADD CONSTRAINT `equipo_ibfk_6` FOREIGN KEY (`id_antivirus`) REFERENCES `antivirus` (`id_antivirus`) ON UPDATE CASCADE,
  ADD CONSTRAINT `equipo_ibfk_7` FOREIGN KEY (`id_software`) REFERENCES `software` (`id_software`) ON UPDATE CASCADE;
