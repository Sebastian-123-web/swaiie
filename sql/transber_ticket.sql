...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-03-2020 a las 00:40:54
...
(30, 'Eduardo', 'Medina', 'emedina@transberperu.com', 'Contabilidad', 'SOPORTE', 'Mensaje', 'Tengo problemas con mi pc, el iniciar mi pc se demora en cargar y luego me aparece pantalla zaul con', 'askdjksfheiofudkh21657.jpg', '2019-11-23', '0000-00-00', 'Abierto', 'Alto', '12:21:01', 'TBGRGAFSI002', 'El disco duro esta daÃ±ado, se reemplazo por otro disco de mas capacidad y se agrego mas memoria RAM(+2GB).'),
(31, 'Angel', 'Gil', 'agil@transberperu.com', 'Cobranzas', 'SOPORTE', 'Mensaje', 'Estimado Sistemas, mi equipo no prende, revise el cable poder pero aun asÃ­ no prende por favor necesito con urgencia que lo revisen.\r\ngracias', 'images.jpg', '2019-11-23', '0000-00-00', 'Resuelto', 'Medio', '12:27:42', 'TBGRGAFSI002', 'Problema con el disco duro, el disco presenta sectores daÃ±ados que no dejan cargar el sistema operativo.'),
